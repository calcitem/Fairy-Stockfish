...
int best_group(size_t idx)
{
    ...
    auto fun1 = (fun1_t)(void (*)())GetProcAddress(k32, "GetLogicalProcessorInf"
                                                        "ormationEx");
    if (!fun1)
        return -1;
    ...
    ptr = buffer = (SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX *)malloc(
        returnLength);
...
void bindThisThread(size_t idx)
{
    ...
    HMODULE k32 = GetModuleHandle("Kernel32.dll");
    auto fun2 = (fun2_t)(void (*)())GetProcAddress(k32, "GetNumaNodeProcessorMa"
                                                        "skEx");
    auto fun3 = (fun3_t)(void (*)())GetProcAddress(k32, "SetThreadGroupAffinit"
                                                        "y");
