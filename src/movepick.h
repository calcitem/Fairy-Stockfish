...
typedef Stats<int16_t, 13365, COLOR_NB,
              int(SQUARE_NB + 1) * int(1 << SQUARE_BITS)>
    ButterflyHistory;
...
typedef Stats<int16_t, 10692, MAX_LPH,
              int(SQUARE_NB + 1) * int(1 << SQUARE_BITS)>
    LowPlyHistory;
...
typedef Stats<PieceToHistory, NOT_USED, 2 * PIECE_SLOTS, SQUARE_NB>
    ContinuationHistory;
