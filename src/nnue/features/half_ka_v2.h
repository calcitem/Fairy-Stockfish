...
class HalfKAv2
{
    ...
    static constexpr uint32_t PieceSquareIndex[COLOR_NB][PIECE_NB] = {
        ...
        // viewed from other side, W and B are reversed
        {
            ...
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            ...
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_NONE,     PS_NONE,   PS_NONE,
            PS_NONE, PS_NONE,   PS_NONE,     PS_KING,
    ...
    static_assert(PieceSquareIndex[WHITE][make_piece(WHITE, PAWN)] ==
                  PS_W_PAWN);
    static_assert(PieceSquareIndex[WHITE][make_piece(WHITE, KING)] == PS_KING);
    static_assert(PieceSquareIndex[WHITE][make_piece(BLACK, PAWN)] ==
                  PS_B_PAWN);
...
public:
    ...
    static constexpr IndexType Dimensions = static_cast<IndexType>(
                                                SQUARE_NB_CHESS) *
                                            static_cast<IndexType>(PS_NB);
